            ...
            <Grid container spacing={6}>
                <Grid item xs={6}>
                    <Link to="/barcode_generator">
                        <Button variant="contained" size="large" color="secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" style={{padding: 30}}
                                 fill="currentColor" className="bi bi-upc" viewBox="0 0 16 16">
                                <path
                ...
                <Grid item xs={6}>
                    <Link to="/barcode_scanner">
                        <Button variant="contained" size="large" color="secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" style={{padding: 30}}
                                 fill="currentColor" className="bi bi-upc-scan" viewBox="0 0 16 16">
                                <path
